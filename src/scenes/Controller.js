...
let Controller = (props) => {
    return (
        <Viewbox>
            <rect strokeWidth="5" stroke="rgba(255,255,255,0.2)" stroke="rgba(255,255,255,0.2)" fill="black" x={-600} y={-450} width={1200} height={900} onClick={() => props.sceneChange("start")} />
