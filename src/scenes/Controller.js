...
let Controller = (props) => {
    return (
        <Viewbox>
            ...
            <rect stroke="rgba(255,255,255,0.2)" fill="black" x={-250 + 400 / -2} y={-450} width={400} height={900} onClick={() => props.sceneChange("start")} />
            ...
            <rect fill="rgba(255,255,255,0.2)" x={250 + 420 / -2} y={-460} width={420} height={920} />
            <rect stroke="rgba(255,255,255,0.2)" x={250 + 400 / -2} y={-450} width={400} height={900} />
