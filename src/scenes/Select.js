    ...
    render = () => {
        return (
            <Viewbox>
                ...
                <rect x={-225 + 400 / -2} y={-225 + 400 / -2} width="400" height="400" stroke="white" fill="transparent" onClick={() => this.props.selectEnemy("scene1")}></rect>
                ...
                <rect x={225 + 400 / -2} y={-225 + 400 / -2} width="400" height="400" stroke="white" fill="transparent" onClick={() => this.props.selectEnemy("scene2")}></rect>
                {(!this.props.blood) && <rect x={225 + 400 / -2} y={-225 + 400 / -2} width="400" height="400" stroke="white" fill="rgba(0,0,0,0.85)" ></rect>}

                {EnemySVG.nul(nul)}
                <rect x={-225 + 400 / -2} y={225 + 400 / -2} width="400" height="400" stroke="white" fill="transparent" onClick={() => this.props.selectEnemy("scene3")}></rect>
                {(!this.props.nul) && <rect x={-225 + 400 / -2} y={225 + 400 / -2} width="400" height="400" stroke="white" fill="rgba(0,0,0,0.85)" ></rect>}

                {EnemySVG.vida(vida)}
                <rect x={225 + 400 / -2} y={225 + 400 / -2} width="400" height="400" stroke="white" fill="transparent" onClick={() => this.props.selectEnemy("scene4")}></rect>
                ...
                {(!this.props.vida) && (!this.props.blood) && (!this.props.sakura) && (!this.props.nul) && <g>
                    <rect x={-200} y={-200} width="400" height="400" stroke="white" fill="black" onClick={() => this.props.selectEnemy("scene5")} />
                    {EnemySVG.ava(ava)}
                </g>}
            </Viewbox>
        )
